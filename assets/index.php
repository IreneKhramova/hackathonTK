  ...
  <body data-spy="scroll" data-offset="0" data-target="#theMenu">
	...
	<nav class="menu" id="theMenu">
		<div class="menu-wrap">
			...
			<a href="#about" class="smoothScroll">Карта</a>
	...
	<div id="w">
		<div class="container">
			<div class="row">
				...
				<h3>ХОТИТЕ <bold>ПОУЖИНАТЬ</bold> В ГОРОДЕ <bold>САРАНСК</bold> И НЕ ЗНАЕТЕ <bold>ГДЕ</bold>? ПРЕДЛАГАЕМ ОЗНАКОМИТЬСЯ С РЕСТОРАНАМИ И КАФЕ ГОРОДА - ОРГАНИЗАТОРА <bold>ЧМ 2018</bold>.
				</h3>
				</div>
			</div>
		</div><!-- /container -->
